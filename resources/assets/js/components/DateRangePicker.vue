<template>
  <div class="daterange-picker" v-on-clickaway="closeCal" @keyup="close">
    <div class="inputs-container">
      <img src="/img/download.svg" class="calendar" alt="calendar">

      <input type="text"
              maxlength="10"
              ref="startDateInput"
              class="start-date rounded text-center font-semibold shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight"
      ...
      <input type="text"
             maxlength="10"
             ref="endDateInput"
             class="end-date text-center rounded font-semibold shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight"
    ...
    <div class="calendar-holder" :class="createCalHolderClass" v-show="showCalendar">
      ...
      <div class="arrow-left flex" ref="leftArrow" :class="{disabled: canSwitchNextMonth}" @click="gotoPrevMonth">&lsaquo;</div>
      <div class="arrow-right flex" ref="rightArrow" :class="{disabled: canSwitchPrevMonth}" @click="gotoNextMonth">&rsaquo;</div>
